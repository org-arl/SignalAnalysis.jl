...
const TimeQuantity = Quantity{T,Unitful.𝐓,S} where {T,S}
const FreqQuantity = Quantity{T,Unitful.𝐓^-1,S} where {T,S}
...
Base.getindex(s::AbstractArray, t::Quantity{T,Unitful.𝐓,U}, ndx...) where {T,U} = s[toindex(t),ndx...]
